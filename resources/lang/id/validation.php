...
return [
    ...
    */
    ...
    'lte'                  => [
        ...
        'numeric' => ':attribute harus kurang dari atau sama dengan :value kilobita.',
    ...
    'required'             => ':attribute wajib diisi.', // <<< PENTING! PASTIKAN INI ADA
    ...
    */
    ...
    'attributes' => [
        ...
        'available' => 'Tersedia',
        'size' => 'Ukuran',
        'pasien' => 'Pasien', // <<< Tambahkan ini jika nama field Anda 'pasien'
        'dokter' => 'Dokter', // <<< Tambahkan ini jika nama field Anda 'dokter'
        'tanggal_rekam_medis' => 'Tanggal Rekam Medis', // <<< Tambahkan ini jika nama field Anda 'tanggal_rekam_medis'
    ],
